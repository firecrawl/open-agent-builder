...
export class LangGraphExecutor {
  ...
  private apiKeys?: { anthropic?: string; groq?: string; openai?: string; novita?: string; firecrawl?: string; arcade?: string };
  ...
  constructor(
    ...
    apiKeys?: { anthropic?: string; groq?: string; openai?: string; novita?: string; firecrawl?: string; arcade?: string }
  ) {
