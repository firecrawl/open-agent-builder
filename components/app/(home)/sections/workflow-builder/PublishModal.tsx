            ...
            {!published ? (
              <>
                ...
                <div className="p-24 space-y-20">
                  ...
                  {/* Public Access */}
                  <div className="flex items-center justify-between p-16 bg-card rounded-12">
                    <div>
                ...
                <div className="p-24">
                  ...
                  <div className="mb-24">
                    ...
                    <div className="flex gap-8">
                      <div className="flex-1 px-12 py-10 bg-card rounded-8 text-body-small text-foreground font-mono overflow-x-auto">
                        {endpointUrl}
                      </div>
                      <button
                        onClick={handleCopyEndpoint}
                        className="px-16 py-10 bg-card hover:bg-black-alpha-4 border border-border-faint rounded-8 text-body-small text-foreground transition-colors"
                      >
                        Copy
                      </button>
                    </div>
                  ...
                  <div className="mb-24">
                    ...
                    <div className="relative">
                      <pre className="px-12 py-10 bg-card text-green-400 rounded-8 text-body-small font-mono overflow-x-auto">
