      ...
      {node && (
        ...
        >
          ...
          <div className="p-20 border-b border-border-faint bg-heat-4">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-8">
                ...
                <h2 className="text-title-h3 text-foreground">Sticky Note</h2>
              </div>
              <div className="flex items-center gap-8">
                <button
                  ...
                  title="Delete note"
                >
                  <svg className="w-16 h-16 text-heat-100 group-hover:text-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                  <svg className="w-16 h-16 text-heat-100 dark:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="p-20">
            {/* Sticky Note */}
            <div>
              <label className="block text-sm font-medium text-foreground mb-8 flex items-center gap-8">
              ...
              <textarea
                ...
                className="w-full px-14 py-10 bg-heat-4 dark:bg-[#1c1d24] border border-heat-100 dark:border-[#2a2a2f] rounded-10 text-sm text-foreground dark:text-white placeholder-black-alpha-48 placeholder:opacity-50 focus:outline-none focus:border-heat-100 transition-colors resize-y font-sans"
