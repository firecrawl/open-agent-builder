            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex items-center gap-8">
                <button
                  ...
                  title="Delete node"
                >
                  <svg className="w-16 h-16 text-black-alpha-72 dark:text-gray-400 group-hover:text-black-alpha-64 dark:group-hover:text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <>
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-12 py-10 bg-card dark:bg-[#1c1d24] rounded-8 text-body-medium text-foreground dark:text-white font-mono focus:outline-none focus:border-heat-100 transition-colors resize-none"
                  />
                  <p className="text-body-small text-black-alpha-48 dark:text-gray-300 mt-8">
                      ...
                      <div className="flex flex-wrap gap-6">
                        {availableVars.inputVars.map((v: any, idx: number) => (
                          <button
                            ...
                            className="px-10 py-6 bg-heat-8 hover:bg-heat-12 text-foreground rounded-6 text-xs font-mono transition-colors"
                            title={v.description}
                          >
                            {v.path}
                          </button>
                ...
                <div className="p-16 bg-card rounded-12">
                  ...
                  <div className="grid grid-cols-2 gap-8">
                    <button
                      ...
                      className="text-left px-12 py-8 bg-card hover:bg-heat-4 rounded-6 transition-colors"
                    >
                      <p className="text-xs font-mono text-heat-100">input.score &gt; 70</p>
                      <p className="text-xs text-black-alpha-48 dark:text-gray-400 mt-2">Number check</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-black-alpha-48 dark:text-gray-400 mt-2">String equals</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-black-alpha-48 dark:text-gray-400 mt-2">Array not empty</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-black-alpha-48 dark:text-gray-400 mt-2">JSON nested</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-black-alpha-48 dark:text-gray-400 mt-2">Range check</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-black-alpha-48 dark:text-gray-400 mt-2">Array contains</p>
                    </button>
                  </div>
                </div>
              </>
                ...
                <div className="p-16 bg-card rounded-12">
                  ...
                  <div className="grid grid-cols-2 gap-8">
                    ...
                    >
                      ...
                      <p className="text-xs text-black-alpha-48 dark:text-gray-400 mt-2">Fixed iterations</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-black-alpha-48 dark:text-gray-400 mt-2">Array processing</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-black-alpha-48 dark:text-gray-400 mt-2">Has more pages</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-black-alpha-48 dark:text-gray-400 mt-2">Retry until good</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-black-alpha-48 dark:text-gray-400 mt-2">Process queue</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-black-alpha-48 dark:text-gray-400 mt-2">JSON array access</p>
                    </button>
                  </div>
                </div>
              ...
              <>
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-12 py-10 bg-card rounded-8 text-body-medium text-foreground focus:outline-none focus:border-heat-100 transition-colors resize-none"
                  />
                  <p className="text-body-small text-black-alpha-48 dark:text-gray-300 mt-8">
                ...
                <div className="p-16 bg-card rounded-12">
                  ...
                  <div className="grid grid-cols-1 gap-8">
                    ...
                    >
                      ...
                      <p className="text-xs text-black-alpha-48 dark:text-gray-400 mt-2">Simple approval with data</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-black-alpha-48 dark:text-gray-400 mt-2">Financial approval</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-black-alpha-48 dark:text-gray-400 mt-2">User action approval</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-black-alpha-48 dark:text-gray-400 mt-2">Detailed approval with formatting</p>
                    </button>
                  </div>
                </div>
                ...
                <div className="p-16 bg-heat-4 rounded-12 border border-heat-100">
                  ...
                  <div className="flex gap-8 text-xs">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-black-alpha-64 dark:text-gray-400">Approve branch</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-full bg-red-500"></div>
                      <span className="text-black-alpha-64 dark:text-gray-400">Reject branch</span>
                    </div>
                  </div>
                </div>
              </>
